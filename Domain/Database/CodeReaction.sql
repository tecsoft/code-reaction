CREATE TABLE "Comments" ("Id" INTEGER PRIMARY KEY  NOT NULL ,"Revision" INTEGER NOT NULL ,"User" VARCHAR DEFAULT (null) ,"File" VARCHAR DEFAULT (null) ,"LineId" VARCHAR, "Text" VARCHAR, "ReplyToId" INTEGER);
